...
<form action="" method="post">
    <div class="container">
        <div class="form-group">
            ...
            <input id="idcard" class="form-control" name="id" <?php echo empty($id)? '' : 'readonly'; ?> type="text" value="<?php echo isset($_POST['id'])? $_POST['id'] : $id; ?>" required>
        </div>
